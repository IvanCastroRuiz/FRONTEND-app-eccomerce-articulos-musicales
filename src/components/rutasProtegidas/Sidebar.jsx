...
const Sidebar = () => {
  return (
    <>
        ...
        >
            <div>
                <img className="bg-gradient-to-tr" src={sideBar} alt="sideBar"/>   
            </div>
            <div>
                <img className="bg-gradient-to-tr" src={sideBar2} alt="sideBar2"/>   
            </div>
            <div>
                <img className="bg-gradient-to-tr" src={sideBar3} alt="sideBar3"/>   
            </div>
            <div>
                <img className="bg-gradient-to-tr" src={sideBar4} alt="sideBar4"/>   
            </div>
        </div>
    </>
  )
